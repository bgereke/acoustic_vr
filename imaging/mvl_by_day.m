...
for d = 1:numdays
    ...
    for m = 1:nummice
        ...
        if exists
            ...
            wheel_position = wheel_position - floor(wheel_position);
            [dF,nF,zF] = deltaF(raw,2);
            [maps,pmap,grid,mvl,dbmvl,mvlp,bpsl,bptl,ftrans] = ratemap(nF,runtable.lap_position,ct,ard_timestamp,100,'nthresh','vonMises',30);
